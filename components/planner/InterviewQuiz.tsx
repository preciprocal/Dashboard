    ...
    return (
      <div className="min-h-[600px] flex items-center justify-center p-6">
        <div className="text-center max-w-xl">
          <div className="w-24 h-24 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-6 border-4 border-red-200 dark:border-red-800">
          ...
          <div className="flex gap-4 justify-center">
            ...
            {onClose && (
              <button
                onClick={onClose}
                className="px-8 py-4 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border-2 border-slate-300 dark:border-slate-600 rounded-xl font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-all"
              >
                Close
              </button>
            )}
      ...
      <div className="max-w-4xl mx-auto p-6 md:p-8">
        ...
        <div className="text-center mb-10">
          ...
          <div className="inline-flex items-center space-x-2 px-4 py-2 bg-blue-100 dark:bg-blue-900/30 rounded-full mb-4">
            ...
            <span className="text-sm font-semibold text-blue-700 dark:text-blue-300">AI-Generated Quiz</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl p-6 text-center">
            ...
            <div className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-1">{metadata?.totalDays || 0}</div>
            <div className="text-sm font-medium text-slate-600 dark:text-slate-300">Study Days Covered</div>
          </div>

          <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-800 rounded-2xl p-6 text-center">
            ...
            <div className="text-4xl font-bold text-purple-600 dark:text-purple-400 mb-1">{questions.length}</div>
            <div className="text-sm font-medium text-slate-600 dark:text-slate-300">Total Questions</div>
          </div>

          <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 border border-amber-200 dark:border-amber-800 rounded-2xl p-6 text-center">
            ...
            <div className="text-4xl font-bold text-amber-600 dark:text-amber-400 mb-1">~{questions.length * 2}</div>
            <div className="text-sm font-medium text-slate-600 dark:text-slate-300">Minutes to Complete</div>
          </div>
        </div>

        {/* Features */}
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-semibold text-slate-900 dark:text-white">Personalized Content</p>
                <p className="text-sm text-slate-600 dark:text-slate-400">Questions from your actual study materials</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-semibold text-slate-900 dark:text-white">Mixed Categories</p>
                <p className="text-sm text-slate-600 dark:text-slate-400">Technical, behavioral & conceptual questions</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-semibold text-slate-900 dark:text-white">Instant Feedback</p>
                <p className="text-sm text-slate-600 dark:text-slate-400">Detailed explanations after each answer</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-semibold text-slate-900 dark:text-white">Performance Analytics</p>
                <p className="text-sm text-slate-600 dark:text-slate-400">Track your progress by category</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto p-6 md:p-8">
        ...
        <div className="text-center mb-10">
          ...
          <div className="inline-flex items-center space-x-3 text-3xl font-bold">
            ...
            <span className="text-slate-900 dark:text-white">{questions.length}</span>
          </div>
        </div>
        ...
        <div className="flex justify-center mb-12">
          <div className="relative w-64 h-64">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-sm text-slate-500 dark:text-slate-400 font-medium">Accuracy</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {Object.entries(categoryBreakdown).map(([key, data]) => {
            ...
            return (
              <div key={key} className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-2xl p-6 hover:shadow-xl transition-shadow">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-bold text-slate-900 dark:text-white capitalize">{key}</p>
                      <p className="text-sm text-slate-500 dark:text-slate-400">{total} questions</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className={`text-3xl font-bold text-${data.color}-600 dark:text-${data.color}-400`}>{percent}%</p>
                  </div>
                </div>
        ...
        {/* Question Results */}
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-8 mb-10">
          ...
          <div className="grid grid-cols-6 md:grid-cols-12 gap-3">
            {answers.map((isCorrect, index) => (
              ...
              >
                ...
                <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-slate-900 dark:bg-slate-700 text-white text-xs px-3 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                  Q{index + 1}: {isCorrect ? '✓' : '✗'}
                </div>
              </div>
            ))}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="flex-1 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-bold py-5 px-6 rounded-2xl border-2 border-slate-300 dark:border-slate-600 transition-all hover:shadow-xl flex items-center justify-center space-x-3 text-lg"
          >
    ...
    <div className="max-w-4xl mx-auto p-6 md:p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            <p className="text-sm font-semibold text-slate-600 dark:text-slate-400">Score</p>
      ...
      {/* Question Card */}
      <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-3xl p-8 md:p-10 shadow-xl">
        {/* Category Header */}
        <div className="flex items-center justify-between flex-wrap gap-3 mb-8">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-bold text-slate-900 dark:text-white">{question.category}</p>
              {question.relatedDay > 0 && (
                <p className="text-xs text-slate-500 dark:text-slate-400">From Day {question.relatedDay}</p>
              )}
            </div>
          </div>
        ...
        {/* Question Text */}
        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-10 leading-relaxed">
          {question.question}
        </h2>
          ...
          {question.options.map((option, index) => {
            ...
            if (!showResult) {
              buttonClass += isSelected
                ? 'border-blue-600 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 shadow-xl scale-[1.02]'
                : 'border-slate-200 dark:border-slate-600 hover:border-slate-300 dark:hover:border-slate-500 hover:bg-slate-50 dark:hover:bg-slate-700/50 hover:shadow-lg';
            } else {
              if (isCorrectOption) {
                buttonClass += 'border-green-500 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 shadow-xl';
              } else if (isSelected && !isCorrect) {
                buttonClass += 'border-red-500 bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/30 dark:to-rose-900/30 shadow-xl';
              } else {
                buttonClass += 'border-slate-200 dark:border-slate-600 opacity-40';
              }
            }
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {showResult && isCorrectOption && (
                    <CheckCircle className="w-7 h-7 text-green-600 dark:text-green-400 flex-shrink-0 ml-4" />
                  )}
                  {showResult && isSelected && !isCorrect && (
                    <XCircle className="w-7 h-7 text-red-600 dark:text-red-400 flex-shrink-0 ml-4" />
                  )}
                </div>
              </button>
            );
