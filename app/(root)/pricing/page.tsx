    ...
    return (
      <div className="flex items-center justify-center px-4" style={{ height: 'calc(100vh - 73px - 3rem)' }}>
        <div className="text-center">
          <div className="w-8 h-8 border-2 border-gray-300 dark:border-white/30 border-t-purple-600 rounded-full animate-spin mx-auto mb-4" />
    ...
    <div className="flex items-center justify-center px-4" style={{ height: 'calc(100vh - 73px - 3rem)' }}>
      <div className="max-w-xl w-full text-center">
        ...
        {isAlreadySubscribed ? (
          <div className="max-w-md mx-auto mb-8">
            <div className="p-4 bg-gradient-to-br from-purple-500/10 via-blue-500/10 to-purple-500/10 dark:from-purple-500/5 dark:via-blue-500/5 dark:to-purple-500/5 backdrop-blur-xl rounded-xl border border-purple-200/50 dark:border-purple-500/20">
              ...
              <p className="text-sm text-gray-600 dark:text-slate-400 mb-2">We&apos;ll send updates to:</p>
        ...
        <div className="pt-6 border-t border-gray-200 dark:border-white/10">
          <p className="text-sm text-gray-600 dark:text-slate-400 mb-3">Currently available:</p>
          <div className="flex flex-wrap items-center justify-center gap-2">
            {[
              ...
              <span
                key={feature}
                className="px-3 py-1.5 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-full text-xs text-gray-700 dark:text-slate-300"
              >
                {feature}
              </span>
            ))}
