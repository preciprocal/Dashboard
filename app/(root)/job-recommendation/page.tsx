...
function JobRecommendationsPage() {
  ...
  const resumeLoadingSteps: LoaderStep[] = [
  ...
  const jobSearchSteps: LoaderStep[] = [
                ...
                style={{ 
                  width: `${
                    jobSearchSteps
                      ...
                      .reduce((acc, step) => acc + (step.weight || 1), 0) /
                    jobSearchSteps.reduce((acc, step) => acc + (step.weight || 1), 0) * 100
                  }%` 
                }}
              />
            </div>
